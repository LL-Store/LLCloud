        ...
        function Canvas(el, option, width, height) {
            ...
            for (var index = 0; index < canvasArray.length; index++) {
                ...
                if (canvas) {
                    ...
                    canvas.setAttribute('width', ((index === 1 ? option.scale : 1) * width) + "");
                    canvas.style.height = height + "px";
                    canvas.setAttribute('height', ((index === 1 ? option.scale : 1) * height) + "");
                }
            }
            ...
            _this.__el = el;
            _this.painter.scale(option.scale, option.scale);
            return _this;
        }
